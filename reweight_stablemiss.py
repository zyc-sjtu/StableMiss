...
from metric import intra_feature_correlation, intra_mask_correlation, inter_correlation
...
if __name__ == '__main__':
    ...
    for epoch in range(NUM_EPOCH):
        ...
        optimizer.zero_grad()
        w = model()
        loss = intra_feature_correlation(x, m, w) + intra_mask_correlation(m, w) + inter_correlation(x, m, w)
